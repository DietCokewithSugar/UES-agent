...
const MODEL_DEFINITIONS = {
  [EvaluationModel.ETS]: `
    ...
    ** 重要提示：维度名称格式 **
    维度名称必须只使用以下纯中文名称，不得添加任何英文：功能流程、信息认知、交互设计、系统性能、信息安全、视觉设计、智能化、运营服务。
    ...
    * 4.1 系统稳定性：设计是否预留安全区？文字溢出是否会破坏布局？是否有明确的异常/空状态设计？异常状态处理：仔细检查截图中是否有提示框、弹窗或空状态页。如果存在"网络错误"、"系统繁忙"等提示。
